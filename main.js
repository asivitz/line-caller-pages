...
var author$project$Update$delete = F2(
	function (i, l) {
		if (l.b) {
			var x = l.a;
			var xs = l.b;
			return (!i) ? xs : A2(
				elm$core$List$cons,
				x,
				A2(author$project$Update$delete, i - 1, xs));
		} else {
			return _List_Nil;
		}
	});
				...
				switch (msg.$) {
					...
					case 'DeleteGame':
						return _Utils_update(
							model,
							{
								games: A2(author$project$Update$delete, model.index, model.games),
								index: A2(
									elm$core$Basics$max,
									0,
									A2(
...
var author$project$Messages$DeleteGame = {$: 'DeleteGame'};
			...
			[
				...
				_List_fromArray(
					[
						...
						A2(author$project$View$renderButton, 'Delete Game', author$project$Messages$DeleteGame),
