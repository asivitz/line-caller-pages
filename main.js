...
var author$project$Linecaller$subscriptions = function (model) {
...
var author$project$Model$decodePosition = function (s) {
	switch (s) {
		case 'handler':
			return author$project$Model$Handler;
		case 'cutter':
			return author$project$Model$Cutter;
		default:
			return author$project$Model$Handler;
	}
};
var author$project$Model$Balanced = {$: 'Balanced'};
var author$project$Model$Defense = {$: 'Defense'};
var author$project$Model$Offense = {$: 'Offense'};
var author$project$Model$decodeSide = function (s) {
	switch (s) {
		case 'offense':
			return author$project$Model$Offense;
		case 'defense':
			return author$project$Model$Defense;
		case 'balanced':
			return author$project$Model$Balanced;
		default:
			return author$project$Model$Balanced;
	}
};
...
var author$project$Model$decodePlayer = A5(
	...
	A2(
		...
		'position',
		A2(elm$json$Json$Decode$map, author$project$Model$decodePosition, elm$json$Json$Decode$string)),
	A2(
		elm$json$Json$Decode$field,
		'side',
...
var author$project$Model$roster = Gizra$elm_all_set$EverySet$fromList(
	_List_fromArray(
		[
			A4(author$project$Model$Player, 'Andrew', author$project$Model$Cutter, author$project$Model$Offense, author$project$Model$Male),
			A4(author$project$Model$Player, 'Bond', author$project$Model$Handler, author$project$Model$Offense, author$project$Model$Male),
			A4(author$project$Model$Player, 'Chris', author$project$Model$Cutter, author$project$Model$Offense, author$project$Model$Male),
			A4(author$project$Model$Player, 'Deuce', author$project$Model$Handler, author$project$Model$Defense, author$project$Model$Male),
			A4(author$project$Model$Player, 'Gant', author$project$Model$Cutter, author$project$Model$Offense, author$project$Model$Male),
			A4(author$project$Model$Player, 'Holden', author$project$Model$Handler, author$project$Model$Defense, author$project$Model$Male),
			A4(author$project$Model$Player, 'Jacob', author$project$Model$Cutter, author$project$Model$Balanced, author$project$Model$Male),
			A4(author$project$Model$Player, 'Matt', author$project$Model$Cutter, author$project$Model$Balanced, author$project$Model$Male),
			A4(author$project$Model$Player, 'Nacho', author$project$Model$Handler, author$project$Model$Defense, author$project$Model$Male),
			A4(author$project$Model$Player, 'Nick', author$project$Model$Handler, author$project$Model$Balanced, author$project$Model$Male),
			A4(author$project$Model$Player, 'Ray', author$project$Model$Cutter, author$project$Model$Defense, author$project$Model$Male),
			A4(author$project$Model$Player, 'Varun', author$project$Model$Cutter, author$project$Model$Defense, author$project$Model$Male),
			A4(author$project$Model$Player, 'Rosty', author$project$Model$Handler, author$project$Model$Offense, author$project$Model$Female),
			A4(author$project$Model$Player, 'Erica', author$project$Model$Cutter, author$project$Model$Offense, author$project$Model$Female),
			A4(author$project$Model$Player, 'Hannah', author$project$Model$Handler, author$project$Model$Defense, author$project$Model$Female),
			A4(author$project$Model$Player, 'Hops', author$project$Model$Cutter, author$project$Model$Balanced, author$project$Model$Female),
			A4(author$project$Model$Player, 'Jaqs', author$project$Model$Handler, author$project$Model$Balanced, author$project$Model$Female),
			A4(author$project$Model$Player, 'Ksass', author$project$Model$Handler, author$project$Model$Balanced, author$project$Model$Female),
			A4(author$project$Model$Player, 'Lauren', author$project$Model$Cutter, author$project$Model$Offense, author$project$Model$Female),
			A4(author$project$Model$Player, 'Lisa', author$project$Model$Cutter, author$project$Model$Defense, author$project$Model$Female),
			A4(author$project$Model$Player, 'Maya', author$project$Model$Cutter, author$project$Model$Balanced, author$project$Model$Female),
			A4(author$project$Model$Player, 'Meg', author$project$Model$Handler, author$project$Model$Balanced, author$project$Model$Female),
			A4(author$project$Model$Player, 'Sam', author$project$Model$Cutter, author$project$Model$Balanced, author$project$Model$Female)
		]));
...
var author$project$Model$decodeGame = A6(
	...
	A2(
		elm$json$Json$Decode$field,
		'points',
		elm$json$Json$Decode$list(author$project$Model$decodePoint)),
	A2(
		elm$json$Json$Decode$field,
		'line',
		A2(
...
var author$project$Update$modifyAt = F3(
	function (f, i, l) {
		if (l.b) {
			var x = l.a;
			var xs = l.b;
			return (!i) ? A2(
				...
				elm$core$List$cons,
				x,
				A3(author$project$Update$modifyAt, f, i - 1, xs));
		} else {
			return _List_Nil;
		}
	});
...
var Gizra$elm_all_set$EverySet$toList = function (_n0) {
	var d = _n0.a;
...
var author$project$Model$encodeSide = function (g) {
	switch (g.$) {
		case 'Offense':
			return 'offense';
		case 'Defense':
...
var author$project$Model$encodePlayer = function (_n0) {
	var name = _n0.name;
		...
		_List_fromArray(
			[
				...
				elm$json$Json$Encode$string(
					author$project$Model$encodePosition(position))),
				_Utils_Tuple2(
				'side',
				elm$json$Json$Encode$string(
		...
		_List_fromArray(
			[
				...
				A2(
					...
					Gizra$elm_all_set$EverySet$toList(line))),
				_Utils_Tuple2(
				'weScored',
				elm$json$Json$Encode$bool(weScored))
			]));
};
var author$project$Model$encodeGame = function (game) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'points',
				A2(elm$json$Json$Encode$list, author$project$Model$encodePoint, game.points)),
				_Utils_Tuple2(
				'line',
				A2(
					elm$json$Json$Encode$list,
			...
			elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'games',
						A2(elm$json$Json$Encode$list, author$project$Model$encodeGame, model.games)),
						_Utils_Tuple2(
						'index',
						elm$json$Json$Encode$int(model.index))
					])));
	});
...
var Gizra$elm_all_set$EverySet$size = function (_n0) {
	var d = _n0.a;
		...
		switch (msg.$) {
			case 'PickPlayer':
				...
				return (_Utils_cmp(numOfGen, limit) < 0) ? _Utils_update(
					model,
					{
						line: A2(Gizra$elm_all_set$EverySet$insert, p, model.line)
					}) : model;
			case 'RemovePlayer':
				var p = msg.a;
				return _Utils_update(
					model,
					{
						line: A2(Gizra$elm_all_set$EverySet$remove, p, model.line)
					});
			case 'WeScored':
				return _Utils_update(
					model,
			...
			case 'LoadLine':
				...
				return _Utils_update(
					model,
					{
						line: Gizra$elm_all_set$EverySet$fromList(l)
					});
			case 'Noop':
				return model;
			default:
				...
				switch (msg.$) {
					case 'NewGame':
						return _Utils_update(
							model,
							{
								games: A2(elm$core$List$cons, author$project$Model$initialGame, model.games)
							});
					case 'NextGame':
						return _Utils_update(
							model,
							{
								index: A2(elm$core$Basics$max, model.index - 1, 0)
							});
					case 'PrevGame':
						return _Utils_update(
							model,
							{
								index: A2(
									elm$core$Basics$min,
									model.index + 1,
									elm$core$List$length(model.games) - 1)
							});
					default:
						return _Utils_update(
							model,
							{
								games: A3(
									author$project$Update$modifyAt,
									author$project$Update$updateGame(msg),
									model.index,
									model.games)
							});
				}
...
var author$project$Messages$NextGame = {$: 'NextGame'};
var author$project$Messages$PrevGame = {$: 'PrevGame'};
...
var author$project$Messages$LoadLine = function (a) {
	return {$: 'LoadLine', a: a};
};
...
var author$project$View$renderPlayer = F3(
	function (points, msg, p) {
		var twoPointCount = elm$core$List$length(
			A2(
				elm$core$List$filter,
				function (po) {
					return A2(Gizra$elm_all_set$EverySet$member, p, po.line);
				},
				A2(elm$core$List$take, 2, points)));
		var totalPointCount = elm$core$List$length(
			A2(
				elm$core$List$filter,
				function (po) {
					return A2(Gizra$elm_all_set$EverySet$member, p, po.line);
				...
				points));
		var onePointCount = elm$core$List$length(
			A2(
				elm$core$List$filter,
				function (po) {
					return A2(Gizra$elm_all_set$EverySet$member, p, po.line);
...
var author$project$View$renderPlayerList = F3(
	function (points, msg, ps) {
		var os = A2(
			elm$core$List$filter,
			function (p) {
				return _Utils_eq(p.side, author$project$Model$Offense);
			},
			Gizra$elm_all_set$EverySet$toList(ps));
		var ms = A2(
			elm$core$List$filter,
			function (p) {
				return _Utils_eq(p.side, author$project$Model$Balanced);
			},
			Gizra$elm_all_set$EverySet$toList(ps));
		var ds = A2(
			elm$core$List$filter,
			function (p) {
				return _Utils_eq(p.side, author$project$Model$Defense);
			},
			Gizra$elm_all_set$EverySet$toList(ps));
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('player-column')
				]),
			_List_fromArray(
				[
					A2(
...
var author$project$View$renderPlayersDivided = F3(
	function (points, msg, ps) {
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('divided-list')
				]),
			_List_fromArray(
				[
					A3(
...
var author$project$Messages$RemovePlayer = function (a) {
	return {$: 'RemovePlayer', a: a};
};
var author$project$View$enumerate = function (l) {
	if (!l.b) {
		return _List_Nil;
	} else {
		var x = l.a;
...
var author$project$View$renderScore = function (ps) {
	...
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$text(
				elm$core$String$fromInt(ourScore)),
				elm$html$Html$text(' - '),
				elm$html$Html$text(
...
var author$project$View$renderScoreInfo = F2(
	function (ps, x) {
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$class('score-info')
				]),
			_List_fromArray(
				[
					A2(
...
var author$project$View$renderPoint = function (ps) {
	if (ps.b) {
		var x = ps.a;
		var xs = ps.b;
		return A2(
			...
			_List_fromArray(
				[
					A2(author$project$View$renderScoreInfo, ps, x),
					A3(
...
var author$project$View$renderPoints = function (_n0) {
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$View$renderButton,
								'MS',
								author$project$Messages$LoadLine(author$project$Model$meteorSwarm)),
								A2(
								author$project$View$renderButton,
								'LB',
								author$project$Messages$LoadLine(author$project$Model$lightningBolt)),
								A2(
								author$project$View$renderButton,
								'MW',
								author$project$Messages$LoadLine(author$project$Model$magicWeapon)),
								A2(
								author$project$View$renderButton,
								'RS',
								author$project$Messages$LoadLine(author$project$Model$rayOfSickness)),
								A2(
								author$project$View$renderButton,
								'RF',
								author$project$Messages$LoadLine(author$project$Model$rayOfFrost)),
								A2(
								author$project$View$renderButton,
								'F',
								author$project$Messages$LoadLine(author$project$Model$fear)),
								A2(
								author$project$View$renderButton,
								'CS',
								author$project$Messages$LoadLine(author$project$Model$counterSpell)),
								A2(
								author$project$View$renderButton,
								'D',
								author$project$Messages$LoadLine(author$project$Model$darkness))
							])),
						A2(
						elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								...
								A2(Gizra$elm_all_set$EverySet$diff, model.players, model.line))
							]))
					]))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('game-buttons')
					]),
				_List_fromArray(
					[
						A2(author$project$View$renderButton, '<', author$project$Messages$PrevGame),
						A2(author$project$View$renderButton, 'New Game', author$project$Messages$NewGame),
						A2(author$project$View$renderButton, '>', author$project$Messages$NextGame)
					])),
				A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						elm$core$String$fromInt(
							elm$core$List$length(model.games) - model.index)),
				...
				A2(elm$html$Html$hr, _List_Nil, _List_Nil),
				function () {
				var _n0 = A2(author$project$View$pick, model.index, model.games);
				if (_n0.$ === 'Just') {
					var g = _n0.a;
...
var author$project$Linecaller$main = elm$browser$Browser$element(
	{
		init: function (value) {
			return _Utils_Tuple2(
				A2(
		...
		subscriptions: author$project$Linecaller$subscriptions,
		update: author$project$Update$update,
		view: author$project$View$view
	});
_Platform_export({'Linecaller':{'init':author$project$Linecaller$main(elm$json$Json$Decode$value)(0)}});}(this));